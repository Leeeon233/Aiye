...
class CompleteInfoActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        stu_user = AppContext.User as Student
    }
        ...
        when (v.id) {
            ...
            R.id.btn_submit -> {
                if(imagePath.isNullOrEmpty()||
                    ...
                    loading(Const.SHOW)
                    CompleteInfo()
                    /*stu_user!!.name = name_text.text.toString()
                    stu_user!!.id = id_text.text.toString()
                    stu_user!!.avatar_path = imagePath
                    SaveData.name = name_text.text.toString()
                    SaveData.id = id_text.text.toString()
                    SaveData.avatar_path = imagePath!!
