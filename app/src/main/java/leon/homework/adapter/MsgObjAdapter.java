...
public class MsgObjAdapter extends ArrayAdapter<MsgObject> {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.unreadnum = new BadgeView(AppContext.Companion.getInstance());
        ...
        viewHolder.unreadnum.setTargetView(viewHolder.msgIcon);
        viewHolder.unreadnum.setBadgeCount(msgObject.getUnreadnum());
        return view;
    }
